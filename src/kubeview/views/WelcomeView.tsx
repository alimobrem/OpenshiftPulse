      ...
      <div className="max-w-5xl mx-auto px-6 py-10 space-y-10">
        ...
        <section aria-labelledby="all-views-heading">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-2">
            ...
            <ViewTile icon={<Bot className="w-4 h-4 text-violet-400" />} title="Agent"          onClick={() => { useUIStore.getState().openDock('agent'); }} />
            <ViewTile icon={<Settings className="w-4 h-4 text-slate-400" />}  title="Administration" onClick={() => go('/admin', 'Administration')} />
        ...
        <section aria-labelledby="capabilities-heading">
          ...
          <div className="rounded-xl border border-slate-800/60 bg-slate-900/50 divide-y divide-slate-800/60">
            ...
            <CapabilityRow iconColor="text-violet-400" icon={<Bot className="w-4 h-4" />} title="AI Agent" description="Claude-powered SRE diagnostics, security scanning, and cluster operations" onClick={() => { useUIStore.getState().openDock('agent'); }} />
